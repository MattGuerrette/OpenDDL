...
namespace Terathon
{
    ...
    enum : DataResult
    {
        ...
        kDataPropertyInvalidType =
            'PPIT', ///< A property has specified an invalid type. This error is generated if the $@Structure::ValidateProperty@$ function does not specify a recognized data type.
        ...
        kDataPrimitiveInvalidState = 'PMST',     ///< A state identifier contained in primitive array data is not recognized. This error is generated when the
                                                 ///< $@Structure::GetStateValue@$ function returns $false$.
        kDataInvalidStructure =
            'IVST' ///< A structure contains a substructure of an invalid type, or a structure of an invalid type appears at the top level of the file. This error is generated when
                   ///< either the $@Structure::ValidateSubstructure@$ function or $@DataDescription::ValidateTopLevelStructure@$ function returns $false$.
    };
