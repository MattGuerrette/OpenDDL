...
namespace Terathon
{
    struct vec_float
    {
        ...
        operator volatile __m128&(void) volatile
        {
            return (v);
        }
        operator const volatile __m128&(void) const volatile
        {
            return (v);
        }
        ...
        operator volatile float32x4_t&(void) volatile
        {
            return (v);
        }
        operator const volatile float32x4_t&(void) const volatile
        {
            return (v);
        }
    ...
    struct exv_float
    {
        ...
        operator volatile __m256&(void) volatile
        {
            return (v);
        }
        operator const volatile __m256&(void) const volatile
        {
            return (v);
        }
